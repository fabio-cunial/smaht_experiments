...
task SnifflesImpl {
    ...
    parameter_meta {
        coverage: "Estimate of the coverage of the BAM."
        min_supporting_reads: "Minimum number of reads that support a call. Used only if nonzero."
    }
