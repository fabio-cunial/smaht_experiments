...
* One healthy liver sample ([donor ST001](https://data.smaht.org/data/benchmarking/donor-st001#liver) in the benchmarking section of the data portal), sequenced at ~230x  with PacBio Revio and at ~210x with ONT PromethION 24 (coverages estimated from chr1).
